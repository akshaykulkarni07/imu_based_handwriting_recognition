...
uint8_t sensorId;
double aX, aY, aZ, aSqrt, gX, gY, gZ;
double acc_xcal, acc_ycal, acc_zcal, gyro_xcal, gyro_ycal, gyro_zcal;
double acc_x_out = 0, acc_y_out = 0, acc_z_out = 0, gyro_x_out = 0, gyro_y_out = 0, gyro_z_out = 0;
